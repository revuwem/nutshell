<?php
// Отображение списка диалогов пользователя с последним сообщением
...
if(count($resultDialogs)!=0){
    ...
    $output='';
        ...
        $output='<label class="m-2">У вас нет диалогов. Напишите кому-нибудь первое сообщение.</label>';
    };
