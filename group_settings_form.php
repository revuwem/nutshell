<div class="row">
    <div class="col-12 py-2">
        <div class="row">
            ...
            <div class="col-7">
                <form autocomplete="off" enctype="multipart/form-data" id="form_updateGroupPhoto">
                    ...
                    <input class="btn btn-sm  form-control" type="submit" name="btn_update_group_photo"
                        id="btn_update_group_photo" value="Обновить">
                </form>
            </div>
        </div>
    </div>
